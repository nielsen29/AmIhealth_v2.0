...
public class AdapterCinturaGraficas extends RecyclerView.Adapter<AdapterCinturaGraficas.ViewGrafHolder> {

    private ArrayList<MedidasCinturaList> resultados = new ArrayList<>();
    private Context context;
    private ArrayList<LineData> DatosGraf = new ArrayList<>();
    private ArrayList<ArrayList<String>> fechas = new ArrayList<>();

    public AdapterCinturaGraficas(ArrayList<MedidasCinturaList> resultados, Context context) {
     ...
     */
    public ArrayList<LineData> getEntrys(ArrayList<MedidasCinturaList> resultados){
        ...
        for (int i = 0; i < resultados.size() ; i++) {
            ...
            RealmResults<Cintura> realmResult;
            ...
            for (int j = 0; j <realmResult.size() ; j++) {
                ...
                SYS.add(new Entry((float) j,(float) realmResult.get(j).getCintura()));
